...
public class ConstraintNode extends SyntaxNode {

	public final String name;

	private ConstraintNode(Location location, String name) {
		super(location);
		this.name = name;
	}

	public static ConstraintNode parse(TokenStream stream) {
		...
		throw UnimplementedException.ofPlural("constraints");
	}
