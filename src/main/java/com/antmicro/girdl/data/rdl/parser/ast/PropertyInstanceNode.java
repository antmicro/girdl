...
public class PropertyInstanceNode extends SyntaxNode {

	public final String name;

	public PropertyInstanceNode(Location location, String name) {
		super(location);
		this.name = name;
	}

	public static PropertyInstanceNode parse(TokenStream stream) {
		...
		// TODO: arrays
		if (stream.match("[")) {
			stream.peek().error().setUnexpected("array clause").setUnimplemented().raise();
		}

		return new PropertyInstanceNode(identifier, name);
