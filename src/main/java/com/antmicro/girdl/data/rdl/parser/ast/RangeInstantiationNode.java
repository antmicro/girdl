...
public class RangeInstantiationNode extends InstantiationNode {

	public final ExpressionNode end;

	public RangeInstantiationNode(Location location, ExpressionNode start, ExpressionNode end) {
		super(location, Type.RANGE, start);
		this.end = end;
	}
